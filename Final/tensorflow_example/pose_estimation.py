...
def classify_image(interpreter, image, height, width):
...
image = Image.open("pose.jpeg").convert('RGB').resize((width, height))

# Classify the image.
time1 = time.time()
classify_image(interpreter, image, height, width)
time2 = time.time()
